...
export const metadata = {
    title: 'Privacy Policy - IKON',
    description: 'Privacy policy for IKON Pest Control Services. Learn about our data collection and privacy practices.',
};
    ...
    return (
        <main className="bg-white min-h-screen px-6 py-12 sm:px-8 md:px-12 lg:px-24 text-ikontext">
            <div className="max-w-4xl mx-auto space-y-8">
                <header>
                    <h1 className="text-4xl font-bold text-ikontext mb-2">Privacy Policy</h1>
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Interpretation and Definitions</h2>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-ikontext">
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Collecting and Using Your Personal Data</h2>
                    ...
                    <ul className="list-disc list-inside mb-4 text-ikontext space-y-1">
                        <li>Email address</li>
                    ...
                    <ul className="list-disc list-inside text-ikontext space-y-1 mb-4">
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Use of Your Personal Data</h2>
                    <ul className="list-disc list-inside text-ikontext space-y-1 mb-4">
                    ...
                    <ul className="list-disc list-inside text-ikontext space-y-1">
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Data Retention and Transfer</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Your Data Rights</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Disclosures</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Security</h2>
                    <p>We implement reasonable security practices, but no online method is 100% secure.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Third-Party Services</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Children's Privacy</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">External Links</h2>
                    <p>Our site may contain links to other websites. We are not responsible for their content or privacy policies.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-semibold text-ikontext mb-4 border-b pb-1">Policy Updates</h2>
